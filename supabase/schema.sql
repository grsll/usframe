...
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS current_streak INTEGER DEFAULT 1;
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS longest_streak INTEGER DEFAULT 1;
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS last_activity_date DATE DEFAULT CURRENT_DATE;
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS streak_started_at TIMESTAMPTZ DEFAULT now();
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS streak_broken_at TIMESTAMPTZ;
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS pet_level INTEGER DEFAULT 1;
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS pet_xp INTEGER DEFAULT 0;
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS total_xp INTEGER DEFAULT 50;
ALTER TABLE public.couples ADD COLUMN IF NOT EXISTS unlocked_milestones INTEGER[] DEFAULT '{}';
